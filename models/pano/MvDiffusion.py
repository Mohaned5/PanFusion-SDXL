...
class MvDiffusion(PanoGenerator):
    ...
    def embed_prompt(self, batch, num_cameras):
        ...
        prompt_embds_1, prompt_embds_2 = self.encode_text(pers_prompt)
        prompt_embds_1 = rearrange(prompt_embds_1, '(b m) l c -> b m l c', m=num_cameras)
        prompt_embds_2 = rearrange(prompt_embds_2, '(b m) l c -> b m l c', m=num_cameras)
        batch['pers_prompt'] = pers_prompt
        return (prompt_embds_1, prompt_embds_2)
